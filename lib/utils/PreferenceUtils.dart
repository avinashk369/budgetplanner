...
/**
 * saving object in json format and returnig the same
 */
  static readObject(String key, {String defValue = ''}) {
    if (_prefs == null) return defValue;
    return json.decode(_prefs.getString(key) ?? defValue);
  }
  ...
  /**
   * end of saving object to the pref
   */
}
